                    ...
                    <div className="flex gap-2">
                      ...
                      {!token && (
                        <button
                          ...
                          className={`bg-gradient-to-r from-primary-500 to-primary-600 text-white px-4 py-3 rounded-xl font-medium hover:from-primary-600 hover:to-primary-700 transition-all whitespace-nowrap ${countdown > 0 && !otpSent ? 'opacity-50 cursor-not-allowed' : ''}`}
                        >
                          {countdown > 0 && !otpSent ? (
